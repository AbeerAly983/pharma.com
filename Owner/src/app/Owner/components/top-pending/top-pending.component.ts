...
@Component({
  selector: 'app-top-pending',
  templateUrl: './top-pending.component.html',
  styleUrls: ['./top-pending.component.css']
})
export class TopPendingComponent {
  chart!: Chart;
  ...
  getTopPending (){
    this._ChartsService.getTopPending().subscribe({
      next:(res)=>{
        this.allOrders = res
