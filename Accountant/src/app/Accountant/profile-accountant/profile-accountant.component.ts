...
import { Accountant, AccountantShortData } from 'src/app/interfaces/Accountant/accountant';
import { updateEmail, updatePassword } from 'src/app/interfaces/Accountant/accountant';
import { Verification } from 'src/app/interfaces/Accountant/auth';
import { UserService } from 'src/app/services/Accountant/user.service';

@Component( {
  selector: 'app-profile-accountant',
  templateUrl: './profile-accountant.component.html',
  styleUrls: ['./profile-accountant.component.css']
} )
export class ProfileAccountantComponent {
  userModel = new User( "", "", "", "", "" );

  user!: Accountant;
  userShortData!: AccountantShortData;
  responseMsg: any;
